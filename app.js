...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(2), __webpack_require__(8).setImmediate))
...
var _vueClipboards = __webpack_require__(9);
...
var _countrycode = __webpack_require__(4);
...
var app = new _vue2.default({
  ...
  methods: {
    ...
    */
    noResultsFound: function noResultsFound(output) {
...
var _loadGoogleMapsApi = __webpack_require__(6);
...
exports.default = {
    ...
    initGoogleMaps: function initGoogleMaps(googleObj) {
      if (!this.loadGoogleApi) {
        ...
        (0, _loadGoogleMapsApi2.default)({
          ...
          _vue2.default.google = google;
          _vue2.default.prototype.$google = google;
          googleObj(google);
        });
      }
    }
  ...
  mounted: function mounted() {
    ...
    if (document.getElementById(this.id)) {
      ...
      this.initGoogleMaps(function (google) {
        _this2.autocomplete = new google.places.Autocomplete(document.getElementById(_this2.id), options);

        // Override the default placeholder text set by 
        // Google with the placeholder prop value
        document.getElementById(_this2.id).setAttribute('placeholder', _this2.placeholder);

        _this2.autocomplete.addListener('place_changed', function () {
          ...
          if (place.address_components !== undefined) {
            ...
            _this2.$emit('input', document.getElementById(_this2.id).value || '');
            _this2.onChange();
          }
        });
      });
  ...
  render: function render(createElement) {
    ...
    return createElement('v-text-field', {
      ...
      }, _defineProperty(_props, 'solo', this.solo), _defineProperty(_props, 'textarea', this.textarea), _defineProperty(_props, 'toggle-keys', this.toggleKeys), _defineProperty(_props, 'type', 'text'), _defineProperty(_props, 'validate-on-blur', this.validateOnBlur), _defineProperty(_props, '@focus', this.onFocus()), _defineProperty(_props, '@blur', this.onFocus()), _defineProperty(_props, '@change', this.onChange()), _defineProperty(_props, '@keypress', this.onKeyPress()), _props),
      domProps: {
      ...
      on: {
        ...
        keypress: function keypress(e) {
          _this3.onKeyPress(e.target.value);
        }
      }
    }, []);
  },
